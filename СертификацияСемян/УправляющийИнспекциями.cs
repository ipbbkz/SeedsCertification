...
public class УправляющийИнспекциями
{
    ...
    public КлассСемян РекомендованныйКлассСемян(int идИнспекции, КлассСемян запрашиваемыйКлассСемян)
    {
        ...
        {
            var записи = ПолучитьПротоколПолевойИнспекции(идИнспекции);
            return ПравилаСертификации.РекомендованныйКлассСемян(записи, запрашиваемыйКлассСемян);
        }

        if (инспекция.ТипИнспекции == 2)
        {
            var партия = ПолучитьПротоколИнспекцииПартии(идИнспекции);
