...
namespace СертификацияСемян.Данные.Migrations
{
    ...
    [Migration("20231018092721_ИдХозяйстваДляУчастка")]
    partial class ИдХозяйстваДляУчастка
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("СертификацияСемян.Данные.Заявка", b =>
                {
                    ...
                    b.Property<int>("ИдПроизводителяСемян")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ИдПроизводителяСемян");
            ...
            modelBuilder.Entity("СертификацияСемян.Данные.Заявка", b =>
                {
                    b.HasOne("СертификацияСемян.Данные.ПроизводительСемян", "ПроизводительСемян")
                        .WithMany()
                        .HasForeignKey("ИдПроизводителяСемян")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
