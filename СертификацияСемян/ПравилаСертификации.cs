...
public class ПравилаСертификации
{
    ...
    public static КлассСемян РекомендованныйКлассСемян(ЗаписьИнспекцииПартии инспекцияПартии)
    {
        ...
        КлассСемян Порог(int? значение, double[] уровни) => ПорогИнспекцииПартии(значение, инспекцияПартии.ИнспектируемыйВес, уровни);
    }

    public static КлассСемян ПорогИнспекцииПартии(int? значение, int вес, double[] уровни)
    {
