...
public class УправляющийЗаявками
{
    ...
    public void ДобавитьЗаявку(
        ...
        string НаваниеКомпанииПроизводителя,
        int ГодПроизводстваСемян,
        ...
        DateTime ДатаСбора)
    {
        контекст.Заявки.Add(new Заявка()
        {
            ...
            НаваниеКомпанииПроизводителя = НаваниеКомпанииПроизводителя,
            КодСертификатаПроисхождения = КодСертификатаПроисхождения,
            ГодПроизводстваСемян = ГодПроизводстваСемян,
